...
export const ThemeToggle: FC = () => {
	...
	return (
		<button
			...
			className="relative flex h-10 w-10 items-center justify-center rounded-full bg-zinc-200/50 hover:bg-zinc-200 dark:bg-zinc-800/50 dark:hover:bg-zinc-800 transition-colors"
